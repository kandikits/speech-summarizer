...
SET REPO_DOWNLOAD_URL=https://github.com/kandikits/speech-summarizer/releases/download/v1.0.0/speech-summarizer-main.zip
SET REPO_DEPENDENCIES_URL=https://raw.githubusercontent.com/kandikits/speech-summarizer/main/requirements.txt
